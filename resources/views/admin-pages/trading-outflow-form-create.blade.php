...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" class="row g-3 " action="{{ route('trading-outflow.store') }}" method="POST">
                            @csrf
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-auto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-floating">
                                        <form action="{{ route('trading-outflow.import') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                        ...
                        <form action="{{ route('trading-outflow.submit') }}" method="POST">
                                    @csrf
 ...
 function fetchFilteredData(page = 1) {
        ...
        const url = "{{ route('trading-outflow.create') }}"; // Make sure to replace this with your route
                    ...
                    tableBody.innerHTML += `
                        <tr data-date="${transaction.date}" data-am-pm="${transaction.time}" data-attendant="${transaction.staff_id}" data-commodity="${transaction.commodity_id}" data-production-origin="${transaction.barangay}">
                            ...
                            <td>
                                ...
                                <form action="/trading-outflow/${transaction.id}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
