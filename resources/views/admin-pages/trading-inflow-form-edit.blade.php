                    ...
                    @foreach ($facilitator_location_vehicles as $location_vehicle)
                        @if ($location_vehicle->vehicle_id)
                            <li class="list-group-item list-group-item-action input-item"
                                ...
                                {{ $location_vehicle->vehicle->plate_number ?? 'N/A' }} ({{ $location_vehicle->vehicle->vehicle_name?? '' }}) - {{ $location_vehicle->location->barangay?? '' }}, {{ $location_vehicle->location->municipality?? '' }}</li>
                        @endif
                    @endforeach
                @endif
