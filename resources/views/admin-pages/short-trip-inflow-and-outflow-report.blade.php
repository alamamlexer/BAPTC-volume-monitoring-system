...
<section class="section dashboard">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <a href="{{ route('short-trip-inflow-and-outflow.create') }}" class="btn btn-primary">Add New Short Trip Trading</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        function fetchFilteredData(page = 1) {
            ...
            const url = "{{ route('short-trip-inflow-and-outflow.index') }}"; // Make sure to replace this with your route
