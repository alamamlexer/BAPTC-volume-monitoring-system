          ...
          <div class="col-lg-12">
              <div class="card">
                  <div class="card-body">
                          ...
                          <table class="table table-bordered" id="">
                              <thead>
                                  <tr>
                                      ...
                                      <th scope="col">
                                        <div class="d-flex align-items-center">
                                            <label for="timeFilter" style="margin-right: 10px;">Type</label>
                                            <select name="time_filter" id="timeFilter" class="form-select" style="border: none; font-weight: bold;" onchange="filterByTime()">
                                                <option value="">All</option>
                                                <option value="IN" {{ request('time_filter') == 'AM' ? 'selected' : '' }}>In</option>
                                                <option value="OUT" {{ request('time_filter') == 'PM' ? 'selected' : '' }}>Out</option>
                                            </select>
                                        </div>
                                    </th>
                      ...
                      <div class="row mb-3">
                          <div class="col-sm-10">
                              <a href="{{ route('short-trip-inflow-and-outflow.create') }}" class="btn btn-primary">Add New Short Trip Inflow</a>
                          </div>
                      </div>
