...
@section('page_title', 'Short Trip Trading Form')
@section('content')
...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
           <li class="breadcrumb-item active">Add a new short trip</li>
        </ol>
    </nav>
</div>
<!-- End Page Title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myForm" class="row g-3 " action="{{ route('staff-short-trip-inflow-and-outflow.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-md-4 position-relative" data-col="5">
                            ...
                            <ul class="dropdown-list list-group position-absolute w-100"
                                ...
                                <li class="list-group-item list-group-item-action input-item"
                                    ...
                                    data-barangay="{{ $location_vehicle->location->barangay ?? null}}"
                                    data-municipality="{{ $location_vehicle->location->municipality ?? null}}"
                                    data-province="{{ $location_vehicle->location->province ?? ''}}"
                                    data-region="{{ $location_vehicle->location->region?? null }}">
                                    {{ $location_vehicle->vehicle->plate_number }} - {{ $location_vehicle->vehicle->vehicle_name??'N/A'}} ({{ $location_vehicle->facilitator->facilitator_name ?? 'N/A'}}) - {{ $location_vehicle->province->barangay?? 'N/A' }} {{ $location_vehicle->location->municipality ?? ''}}
                                </li>
                                @endif
                                @endforeach
                                @endif
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-auto">
                            ...
                            <div class="form-floating">
                                        <form action="{{ route('short-trip-inflow-and-outflow.import') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <select name="type_filter" id="typeFilter" class="form-select" style="border: none; font-weight: bold;" onchange="fetchFilteredData()">
