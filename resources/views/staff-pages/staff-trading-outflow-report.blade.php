...
@section('page_title', 'Staff Trading Outflow')
...
<div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Filter Row -->
                    <div class="row mb-3">
                      <form method="GET" action="{{ route('staff-trading-outflow.index') }}" class="mb-3">
 ...
 function fetchFilteredData(page = 1) {
        ...
        const url = "{{ route('staff-trading-outflow.index') }}"; // Make sure to replace this with your route
