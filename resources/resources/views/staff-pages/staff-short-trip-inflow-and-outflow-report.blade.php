...
<section class="section dashboard">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                            <a href="{{ route('staff-short-trip-inflow-and-outflow.create') }}" class="btn btn-primary">Add New Short Trip Trading</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        function fetchFilteredData(page = 1) {
            ...
            const url = "{{ route('staff-short-trip-inflow-and-outflow.index') }}"; // Make sure to replace this with your route
            ...
            fetch(url + '?' + queryParams.toString(), {
                ...
                const userId = {{ auth()->user()->id }}; // Assuming you're using Blade to pass the user ID
...
.then(data => {
    ...
    if (!Array.isArray(data.data) || data.data.length === 0) {
        ...
        data.data.forEach((transaction, index) => {
            ...
            // Determine whether to show the edit button or unauthorized access message
